    ...
    return (
            <div className="relative z-10 max-w-5xl mx-auto px-4 py-16 text-center">
                ...
                <p className="mt-6 text-lg sm:text-xl md:text-2xl text-gray-300 font-light max-w-3xl mx-auto animate-fade-in delay-200">
                    At <span className="font-semibold text-yellow-300">The Astro Pulse</span>, we delve into the intricate lines of your palm to reveal insights into your personality, destiny, and hidden potentials.
                </p>
